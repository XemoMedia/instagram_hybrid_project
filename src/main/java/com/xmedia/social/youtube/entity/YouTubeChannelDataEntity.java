...
@AllArgsConstructor
@Entity
@Table(name = "youtube_channel_data")
public class YouTubeChannelDataEntity {
    ...
    @OneToMany(mappedBy = "youTubeChannelData", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<YouTubeChannelItemEntity> items;
